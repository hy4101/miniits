package com.miniits.web.webapp.demo.config;

import java.util.LinkedHashMap;
import java.util.Map;

import com.miniits.web.webapp.demo.controller.MyShiroRealm;
...
//      <!-- 用户授权/认证信息Cache, 采用EhCache 缓存 -->
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager) {
        ...
        // 登录成功后要跳转的连接
        shiroFilterFactoryBean.setSuccessUrl("/demo/user");
        shiroFilterFactoryBean.setUnauthorizedUrl("/demo/403");
